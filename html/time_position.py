...
#    static_dir = current_working_dir + '/xxx'+str(static_dir_nb)+'/xxx'+str(static_dir_nb)+'-'+str(i)+'/xxx'+str(static_dir_nb)+'-0-'+str(sal_val_str)+'/temp.dat'
#    static_dir = current_working_dir + '/xxx'+str(static_dir_nb)+'/xxx'+str(static_dir_nb)+'-'+str(i)+'/xxx'+str(static_dir_nb)+'-0-'+str(sal_val_str)+'/12_position.dat'
...
animation_alt2(time,x,y,z,iso,static)
#testing()
